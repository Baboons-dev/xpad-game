    ...
    },
    {
      ...
      icon: (active: boolean) => (
        <Icon w={6} h={6} viewBox="0 0 24 24" color={active ? "#BEF642" : "#595959"} >
          <path fillRule="evenodd" clipRule="evenodd" d="M8.5 3C5.73858 3 3.5 5.23858 3.5 8C3.5 10.7614 5.73858 13 8.5 13C11.2614 13 13.5 10.7614 13.5 8C13.5 5.23858 11.2614 3 8.5 3ZM1.5 8C1.5 4.13401 4.63401 1 8.5 1C12.366 1 15.5 4.13401 15.5 8C15.5 11.866 12.366 15 8.5 15C4.63401 15 1.5 11.866 1.5 8Z" fill="currentColor"/>
          <path fillRule="evenodd" clipRule="evenodd" d="M17.653 10.0206C17.8459 9.50308 18.4218 9.23997 18.9393 9.4329C20.0422 9.84407 21.0236 10.5267 21.7927 11.4176C22.5618 12.3086 23.0939 13.3791 23.3397 14.5301C23.5855 15.6812 23.537 16.8757 23.1989 18.0031C22.8607 19.1304 22.2437 20.1544 21.405 20.9801C20.5662 21.8059 19.5328 22.4068 18.4003 22.7273C17.2678 23.0479 16.0727 23.0776 14.9256 22.8139C13.7785 22.5502 12.7165 22.0015 11.8376 21.2186C10.9588 20.4356 10.2916 19.4437 9.89766 18.3346C9.71283 17.8141 9.98489 17.2424 10.5053 17.0576C11.0258 16.8727 11.5975 17.1448 11.7823 17.6652C12.0637 18.4575 12.5403 19.166 13.168 19.7252C13.7958 20.2845 14.5544 20.6764 15.3737 20.8648C16.1931 21.0531 17.0467 21.0319 17.8556 20.8029C18.6646 20.574 19.4028 20.1447 20.0019 19.5549C20.601 18.9651 21.0417 18.2337 21.2832 17.4284C21.5248 16.6232 21.5593 15.77 21.3838 14.9478C21.2082 14.1256 20.8282 13.361 20.2788 12.7246C19.7294 12.0882 19.0284 11.6006 18.2407 11.3069C17.7232 11.114 17.4601 10.5381 17.653 10.0206Z" fill="currentColor"/>
          <path fillRule="evenodd" clipRule="evenodd" d="M6.5 6C6.5 5.44772 6.94772 5 7.5 5H8.5C9.05228 5 9.5 5.44772 9.5 6V10C9.5 10.5523 9.05228 11 8.5 11C7.94772 11 7.5 10.5523 7.5 10V7C6.94772 7 6.5 6.55228 6.5 6Z" fill="currentColor"/>
          <path fillRule="evenodd" clipRule="evenodd" d="M16.5079 13.1678C16.9012 12.78 17.5344 12.7845 17.9221 13.1778L18.6221 13.8878C19.0079 14.2791 19.0057 14.9084 18.6171 15.297L15.7971 18.117C15.4066 18.5075 14.7734 18.5075 14.3829 18.117C13.9924 17.7265 13.9924 17.0933 14.3829 16.7028L16.5008 14.5849L16.4979 14.582C16.1101 14.1887 16.1146 13.5555 16.5079 13.1678Z" fill="currentColor"/>
        </Icon>
      ),
    },
    {
