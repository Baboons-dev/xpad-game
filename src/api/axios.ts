...
const instance: AxiosInstance = axios.create({
  ...
  headers: {
    ...
    'x-api-key': process.env.REACT_APP_TITLE_X_KEY || '9KVvI9QM_98vtE__EYrhCgxFad-6do8fRB9050923uc',
  },
  params: clean({
    t: new Date().getTime(),
  }),
...
instance.interceptors.request.use(
  async (config) => {
    ...
    config.headers['x-api-key'] =
      process.env.NEXT_PUBLIC_TITLE_X_KEY || '9KVvI9QM_98vtE__EYrhCgxFad-6do8fRB9050923uc';
    return config;
  },
  (error) => {
